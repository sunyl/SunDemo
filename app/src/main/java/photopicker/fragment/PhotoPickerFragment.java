...
public class PhotoPickerFragment extends Fragment {
    public static final String PHOTO_PICKER_TAG = "photo_picker_tag";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFolderViewPannel = rootView.findViewById(R.id.layout_photo_selected_folders_container);
        mFoldersView = (RecyclerView) rootView.findViewById(R.id.photo_selected_folders_list);

        mFoldersView.setLayoutManager(new LinearLayoutManager(getContext()));
        mFoldersView.setAdapter(listAdapter);
...
*/
        photoGridAdapter.setOnPhotoClickListener(new OnPhotoClickListener() {
            ...
            public void onClick(View v, int position, boolean showCamera) {
                ...
                String currentPath = photoGridAdapter.getCurrentPhotoPaths().get(index);
                List<String> photos = photoGridAdapter.getSelectedPhotos();
                int[] screenLocation = new int[2];
                v.getLocationOnScreen(screenLocation);
                ImagePagerFragment imagePagerFragment = ImagePagerFragment.newInstance(photos, currentPath, screenLocation, v.getWidth(), v.getHeight());
    ...
    public void toggleFolderPannel() {
        if (mFolderViewPannel.getVisibility() == View.VISIBLE) {
            ...
            mFolderViewPannel.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.common_crop_out_up_to_bottom));
        } else {
            mFolderViewPannel.setVisibility(View.VISIBLE);
           mFolderViewPannel.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.common_crop_in_bottom_to_up));
        }
    }
    ...
    public boolean checkSelected(String path) {
        return photoGridAdapter.getSelectedPhotoPaths().contains(path);
    }
