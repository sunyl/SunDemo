...
public class DefaultOnDoubleTapListener implements GestureDetector.OnDoubleTapListener {
    ...
    protected photodraweeview.Attacher mAttacher;

    public DefaultOnDoubleTapListener(photodraweeview.Attacher attacher) {
    ...
    public void setPhotoDraweeViewAttacher(photodraweeview.Attacher attacher) {
        mAttacher = attacher;
    }
}
