...
public class PhotoDraweeView extends SimpleDraweeView implements photodraweeview.IAttacher {

    private photodraweeview.Attacher mAttacher;
    ...
    protected void init() {
        if (mAttacher == null || mAttacher.getDraweeView() == null) {
            mAttacher = new photodraweeview.Attacher(this);
        }
    }

    public photodraweeview.Attacher getAttacher() {
        return mAttacher;
    }
